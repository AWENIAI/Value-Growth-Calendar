...
fs.writeFileSync('public/calendar/GLOBAL_KEY.ics', ics); fs.writeFileSync('docs/GLOBAL_KEY.ics', ics);
console.log('GLOBAL_KEY.ics: generated in public/calendar and docs');
